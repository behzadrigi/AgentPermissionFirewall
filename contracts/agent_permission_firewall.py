...
class AgentPermissionFirewall(gl.Contract):
    ...
    def submit_reviewer_vote(
        ...
        assert action_id in self.reviewers
    ...
    def create_execution_receipt(
        ...
        receipt_key = action_id


        self.execution_receipts[receipt_key] = ExecutionReceipt(
            action_id=action_id,
